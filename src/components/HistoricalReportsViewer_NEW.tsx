    ...
    <div className="container-fluid p-4">
      ...
      >
        <div
          ...
          style={{ backgroundColor: "#ffeaa7", color: "#856404" }}
        >
          <h5 className="card-title mb-0 d-flex align-items-center">
            <FileText
              className="me-2"
        ...
        <div className="card-body text-dark">
          <p className="mb-2">
            Use the terminal to generate reports with these commands:
          </p>
          <div
          ...
          >
            <div>
              <strong>Today's Report:</strong> node
              historical-production-report.js today
            </div>
            <div>
              <strong>Specific Date:</strong> node
              historical-production-report.js date 2024-01-15
            </div>
            <div>
              <strong>Date Range:</strong> node historical-production-report.js
              range 2024-01-01 2024-01-31
            </div>
            <div>
              <strong>Search Reports:</strong> node
              historical-production-report.js search "client name"
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="row g-3">
                <div className="col-md-4">
                  ...
                  >
                    ...
                    <div className="small text-muted">
                      {selectedReport.summary?.firstEntry.product}
                    </div>
                    <div className="small text-muted">
                      {selectedReport.summary?.firstEntry.client}
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-4">
                  ...
                  >
                    ...
                    <div className="small text-muted">
                      {selectedReport.summary?.lastEntry.product}
                    </div>
                    <div className="small text-muted">
                      {selectedReport.summary?.lastEntry.client}
                    </div>
                  </div>
                </div>
